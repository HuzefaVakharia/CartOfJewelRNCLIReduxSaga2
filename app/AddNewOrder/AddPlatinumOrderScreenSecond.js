...
let [isLoading, setIsLoading] = useState(false);
 ...
 const gotoOrderScreen = () => {
  ...
  let accessTokenSentToAddOrderScreenSecond='';
    ...
    try {
      AsyncStorage.getItem('login_details_for_nextTimeKey').then((value) => {
        if (value != null) {
          ...
          accessTokenSentToAddOrderScreenSecond=user.token;
   ...
   'supplier_id is:'+supplierIDSentToPlatinumAddOrderSecond+'\n'+
    ...
    //gotoOrderScreen();    
      ...
      const data = new FormData();
       ...
       for(var i=0;i<combineImagesFromGalleryAndCamera.length;i++){
