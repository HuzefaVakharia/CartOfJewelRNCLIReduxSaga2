...
import { registerNewUserPassBodyOnly } from './register.action';
...
const NextRegisterScreen = ({ route, navigation }) =>
{
  ...
  //const newUserCreatedOutput = useSelector(state => state.registerUserReducer);
  ...
  const chkAllFieldsEnteredInNextRegisterScreen = () =>
  {
    ...
    let dataForNewUserRegisteration = {
      name:name,
      shop_name:shop_name,
      address:address,
      contact_no:contact_no,
