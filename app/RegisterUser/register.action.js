...
//export function fetchLoginPassBodyOnly(payload) {
    export function registerNewUserPassBodyOnly(payload) {
  console.log('3333. Payload got inside register.action.js file is:'+JSON.stringify(payload));
  return {
    type: ActionNamesAssociatedWithRegisterUser.REGISTER_USER,
    payload,
  };
